...
@order_bp.route("/api/generate-upi-qr", methods=["POST"])
def generate_upi_qr_route():
    data = request.json
    amount = data.get("amount")
    upi_id = "asalkarhub@upi"  # Replace with your actual UPI
    name = "Asalkar Healthy Hub"

    qr_code_data = generate_upi_qr(amount, upi_id, name)
